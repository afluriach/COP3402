...
IsaFunc operations[12] = {NULL, lit, opr, lod, sto, cal, inc, jmp, jpc, sio, lda, sta};

char opName [][4]  = { "", "LIT", "OPR", "LOD", "STO", "CAL", "INC", "JMP", "JPC", "SIO", "LDA", "STA"};
...
int main(int argc, char **argv)
{
    ...
    if(!dbPrint) printAsm(code, codeLen);
    if(!dsPrint) printTraceHeader();
